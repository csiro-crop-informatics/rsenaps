...
The best way to manage your credentials is with an environment variable, the a `.Renviron` file. Create the `.Renviron` file in root of your directory with contents of the structure:
